...
public class BarChart {
    ...
    public BarChart(TangibleGame p, int barChartHeight){
        ...
        width = parent.windowSizeHeight - (int)(parent.offsetLeft)*4 - parent.topViewSize - parent.scoreViewWidth;
    ...
    public void draw(){    
        ...
        parent.image(surface, xOffset, parent.windowSizeHeight -parent.scoreBoardSize + 10 );    
    }
